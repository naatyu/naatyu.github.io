...
A [Cumulative Distribution Function](/atlas/math/probability/cumulative-distribution-function) describes a distribution in probability space:
...
## Related
- [Cumulative Distribution Function](/atlas/math/probability/cumulative-distribution-function)
