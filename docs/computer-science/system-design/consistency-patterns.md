...
- **Cons**: High latency for writes; system becomes unavailable if too many nodes fail or a network partition occurs (ref: [Availability vs Consistency (CAP)](/atlas/computer-science/system-design/availability-vs-consistency-cap)).
