...
- [DINOv2](/atlas/ai/modalities/computer-vision/models/dinov2)
- [Batch Normalization, Accelerating Deep Network Training by Reducing Internal Covariate Shift](/atlas/ai/foundations/batch-normalization)
