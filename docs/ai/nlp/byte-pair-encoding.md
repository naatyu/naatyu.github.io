...
For comparing models with different tokenizers, perplexity is not directly comparable. Use tokenizer-independent metrics like [bits-per-byte (BPB)](/atlas/ai/deep-learning/byte-latent-transformer).
...
- [Qwen2.5 technical report](/atlas/ai/nlp/models/qwen2-5-technical-report)
