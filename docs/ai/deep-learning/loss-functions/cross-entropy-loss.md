...
Cross-Entropy Loss measures how well a predicted probability distribution matches a target distribution. It is one of the main objectives for classification tasks and is closely related to [Kullback-Leibler Divergence](/atlas/mathematics/probability/kullback-leibler-divergence).
## Concepts
...
- **Entropy:** A measure of uncertainty in a distribution. See [Entropy](/atlas/mathematics/probability/entropy).
- **Kullback-Leibler Divergence:** A divergence that compares two distributions and is used to derive cross-entropy. See [Kullback-Leibler Divergence](/atlas/mathematics/probability/kullback-leibler-divergence).
...
- minimizing cross-entropy is equivalent to minimizing [Kullback-Leibler Divergence](/atlas/mathematics/probability/kullback-leibler-divergence) from the target distribution
...
### Binary Case
Binary Cross-Entropy is the two-class special case of cross-entropy when the target distribution is Bernoulli. See [Binary Cross-Entropy Loss](/atlas/ai/deep-learning/loss-functions/binary-cross-entropy-loss).
