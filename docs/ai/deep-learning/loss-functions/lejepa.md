...
### The Loss Function
The LeJEPA training objective is a weighted combination of a prediction loss and the [Sketched Isotropic Gaussian Regularization](/atlas/ai/deep-learning/loss-functions/sketched-isotropic-gaussian-regularization) (SIGReg) loss:
...
| :--- | :--- | :--- |
| **Philosophy** | "Tricks" like [Stop Gradients](/atlas/ai/deep-learning/stop-gradients) to stop collapse | Theoretically "proven" optimal target |
...
- [Stop Gradients](/atlas/ai/deep-learning/stop-gradients)
