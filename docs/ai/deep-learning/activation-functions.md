...
La sigmoid est aujourd’hui utilisé principalement en dernière couche pour de la classification binaires, généralement couplée à la [Binary Cross-Entropy Loss](/atlas/ai/deep-learning/loss-functions/binary-cross-entropy-loss). 
