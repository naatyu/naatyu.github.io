...
Classic [Scaling Laws](/atlas/ai/training/scaling/scaling-laws) treat pretraining as mostly two-dimensional:
...
This is similar in spirit to [Test-Time Compute](/atlas/ai/inference-serving/performance/test-time-compute), but the compute is built into the model architecture and pretraining objective rather than added as a post-hoc inference strategy.
...
- [Test-Time Compute](/atlas/ai/inference-serving/performance/test-time-compute): spends more compute on harder problems
...
- [Moe Looped Language Models](/atlas/ai/architectures/transformers/moe-looped-language-models): sparse experts can restore expressivity lost by looping dense FFNs
