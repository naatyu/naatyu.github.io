...
## 1. The [Roofline Model](/atlas/systems/performance/roofline-model)
...
The time spent fetching weights and the [KV Cache](/atlas/ai/inference-serving/caching/kv-cache) from memory.
